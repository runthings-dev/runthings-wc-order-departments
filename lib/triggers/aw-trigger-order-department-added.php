...
/**
 * Trigger for when a department is added to an order
 */
class Order_Department_Added extends Trigger
{
    ...
    {
        $this->title = __('Order Department Added', 'runthings-wc-order-departments');
        $this->description = __('Triggers when a department is added to an order.', 'runthings-wc-order-departments');
    ...
    /**
     * Handle the department added event
     */
    public function handle_department_added($order_id, $department_term_id)
    {
