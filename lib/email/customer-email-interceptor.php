...
/**
 * Handles customer email reply-to header modification based on order departments
 */
class CustomerEmailInterceptor
{
    ...
    public function __construct($department_matcher, $settings = null)
    {
